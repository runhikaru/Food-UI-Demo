                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    "カート数 : ${_walletController.walletFood.length}",
                                    style: TextStyle(
                                        fontSize: 19,
                                ...
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    "合計 : ￥${_walletController.totalAmount().toStringAsFixed(0)}",
                                    style: TextStyle(
                                        fontSize: 19,
                                        fontWeight: FontWeight.w500,
                                        color: Colors.white),
                                    ...
                                    child: FadeInLeft(
                                      delay: Duration(
                                          milliseconds:
                                              (index / 0.5 * 500).toInt()),
                                      child: Text(
                                        "￥${_walletController.walletFood[index].price.toStringAsFixed(0)}",
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 23),
